class Area {
  ...
  static draw(surface, data, animationDelay, cellWidth, cellHeight) {
    ...
    newareas.append("rect")
      ...
      .attr("x", function(d) { return (d.startCol - 1) * this.getAttribute("cellWidth"); })
      .attr("y", function(d) { return (d.startRow - 1) * this.getAttribute("cellHeight"); })
      .attr("width", function(d) { return d.numCols * this.getAttribute("cellWidth"); })
      .attr("height", function(d) { return d.numRows * this.getAttribute("cellWidth"); })
